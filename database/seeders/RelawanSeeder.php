...
class RelawanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Relawan::create([
            ...
            'usia_relawan'=> 22,
            'jk_relawan'=> false,
            'alamat_relawan'=> 'Jember, Surabaya',
            'pekerjaan_relawan'=> 'Mahasiswa',
        ...
        Relawan::create([
            'nama_relawan'=>'Mahendy Aryaputra Airlangga',
            'tgllahir_relawan'=> '2003-01-01',
            'usia_relawan'=> 19,
            'jk_relawan'=> false,
            'alamat_relawan'=> 'Pucang Anom, Surabaya',
            'pekerjaan_relawan'=> 'Mahasiswa',
            'notelp_relawan'=>'081357986420',
            'email_relawan'=> 'mahendyairlangga@gmail.com',
            'username_relawan'=> 'mahendy',
            'password_relawan'=>  bcrypt('2468102'),
            'status_relawan'=> true,
            'level'=> 1,
        ]);
        Relawan::create([
