    ...
    <div class="container-fluid vh-100" style="margin-top: 85px">
        ...
        <div class="row">
            <div class="col card m-2">
                <div class="card-body">
                    <img src="img/ev5.jpg" alt="" class="card-img">
            ...
            <div class="col card m-2">
                <div class="card-body">
                    <h5 class="card-title"><b>Go Green!</b></h5>
                    <p class="card-text">Gerakan yang dilaksanakan oleh komunitas pecinta lingkungan guna melestarikan lingkungan dan menciptakan lingkungan yang asri</p>

                    <h5 class="card-title"><b>Timeline Kegiatan</b></h5>
                    <p class="card-text">Date : 10 Oktober 2021 </p>
