...
<div>
    <div class="text-center my-2">
        <h4><strong>Tambah Data Relawan</strong></h4>
    </div>
    <div class= "col-lg-8">
    <form method="post" action="/volunteer">
        ...
        <div class="mb-3">
            <label for="tgllahir_relawan" class="form-label">Tanggal Lahir</label>
        ...
        @enderror
          ...
          <div class="mb-3">
            <label for="usia_relawan" class="form-label">Usia Relawan</label>
        ...
        @enderror
          ...
          <div class="mb-3                        ">
              <label for="jk_relawan" class="form-label">Jenis Kelamin</label>
          ...
          <div class="mb-3">
            <label for="alamat_relawan" class="form-label">Alamat</label>
        ...
        @enderror
          ...
          <div class="mb-3">
            <label for="pekerjaan_relawan" class="form-label">Pekerjaan</label>
        ...
        @enderror
          ...
          <div class="mb-3">
            <label for="notelp_relawan" class="form-label">No. Telp</label>
