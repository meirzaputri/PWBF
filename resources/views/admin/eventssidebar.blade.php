                        ...
                        <tbody>
                            @foreach ($kegiatans as $kegiatan)
                                <tr>
                                    ...
                                    <th>{{ $kegiatan->organisasi->nama_organisasi }}</th>
                                    <th>{{ $kegiatan->lokasi_event }}</th>
                                    <th>{{ $kegiatan->deskripsi_event }}
                                    </th>
                                    <th>
                                        <a href="/detkegiatan/{{ $kegiatan->id }}" class="">
                                            <i class="material-icons" data-toggle="tooltip" title="Show Detail">&#xE264;</i>
                                        </a>
                                        <a href="/events/{{ $kegiatan->id }}/edit" class="edit">
                                            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                        </a>
                                        <a href="" class="delete">
                                            <form action="/events/{{ $kegiatan->id }}" method="post">
                                                @method('delete')
                                                @csrf
