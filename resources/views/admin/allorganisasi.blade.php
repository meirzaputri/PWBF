                    ...
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                <h2 class="ml-lg-2">All Organizations</h2>
                            </div>
                        ...
                        <tbody>
                            @foreach ($organisasis as $organisasi)
                                <tr>
                                    ...
                                    <th>
                                        <a href="/detallorganisasi/{{ $organisasi->id }}" class="">
                                            <i class="material-icons" data-toggle="tooltip" title="Show Detail">&#xE264;</i>
                                        </a>
                                        <a href="/allorganisasi/{{ $organisasi->id }}/edit" class="edit">
                                            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                        </a>
                                        <a href="" class="delete">
                                            <form action="/allorganisasi/{{ $organisasi->id }}" method="post">
                                                @method('delete')
                                                @csrf
