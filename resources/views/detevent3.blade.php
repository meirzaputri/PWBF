    ...
    <div class="container-fluid vh-100" style="margin-top: 85px">
        ...
        <div class="row">
            <div class="col card m-2">
                <div class="card-body">
                    <img src="img/catvol1.jpg" alt="" class="card-img">
            ...
            <div class="col card m-2">
                <div class="card-body">
                    <h5 class="card-title"><b>Cat Save Place</b></h5>
                    <p class="card-text">Merupakan gerakan yang dilakukan oleh komunitas pecinta hewan guna menyelamatkan dan memelihara kucing-kucing liar di jalanan</p>

                    <h5 class="card-title"><b>Timeline Kegiatan</b></h5>
                    <p class="card-text">Date : 15 Oktober 2021 </p>
